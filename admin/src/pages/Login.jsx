      ...
      <div className="flex flex-col gap-5 m-auto items-start p-8 min-w-[340px] sm:min-w-98 border rounded-xl text-zinc-600 text-sm shadow-lg">
        ...
        <div className="w-full">
          ...
          <input
            ...
            className="border w-full border-[#DADADA] rounded-lg p-1.5 mt-1"
            type="email"
        ...
        <button className="bg-primary text-white rounded-lg w-full text-base py-2 hover:scale-105 transition-all duration-200">
          Login
        </button>
        {state === "Admin" ? (
          <p>
